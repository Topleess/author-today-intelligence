...
class ServerContractTest(unittest.TestCase):
    ...
    def test_read_only_and_no_secret_fields(self):
        ...
        payload=[]
        for path in ("/api/health","/api/summary","/api/works","/api/archives","/api/tags","/api/profiles","/api/comments","/api/comments/synthetic-comment-1","/api/authors","/api/rankings","/api/source-quality"):
